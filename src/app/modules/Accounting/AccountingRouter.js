...
const BalancesPage = lazy(() =>
  import("./Balances/pages/BalancesPage")
);

const DiaryBookPage = lazy(() =>
  import("./DiaryBook/pages/DiaryBookPage")
);

const MayorBookPage = lazy(() =>
  import("./MayorBook/pages/MayorBookPage")
);

const VatSalesPage = lazy(() =>
  import("./VatSales/pages/VatSalesPage")
);
  ...
  return (
    <Switch>
      <Route
        ...
        component={checkRouteAccess('accounting.Dashboard', DashboardPage, access)}
      />
      <Route
      ...
      <Route
        ...
        component={checkRouteAccess('accounting.Cuenta Auxiliar', AuxiliaryAccounts, access)}
      />
      <ContentRoute
        path={baseRouterUrl + '/accounting-groups'}
        component={checkRouteAccess('accounting.Grupos Contables', AccountingGroupsPage, access)}
      />
      <ContentRoute
        path={baseRouterUrl + '/subaccounts'}
        component={checkRouteAccess('accounting.Subcuentas', SubaccountsPage, access)}
      />
      <ContentRoute
        path={baseRouterUrl + '/auxiliary-accounts'}
        component={checkRouteAccess('accounting.Cuentas Auxiliares', SubaccountsPage, access)}
      />
      <ContentRoute
        path={baseRouterUrl + '/accounting-entries'}
        component={checkRouteAccess('accounting.Asientos Contables', AccountingEntriesPage, access)}
      />
      <ContentRoute
        path={baseRouterUrl + '/accounting-plan'}
        component={checkRouteAccess('accounting.Plan Contable', AccountingPlanPage, access)}
      />
      <ContentRoute
        path={baseRouterUrl + '/templates-entries'}
        component={checkRouteAccess('accounting.Plantillas Asientos', TemplatesEntriesPage, access)}
      />
      <ContentRoute
        path={baseRouterUrl + '/balances'}
        component={checkRouteAccess('accounting.Sumas y Saldos', BalancesPage, access)}
      />
      <ContentRoute
        path={baseRouterUrl + '/diaryBook'}
        component={checkRouteAccess('accounting.Libro diario', DiaryBookPage, access)}
      />
      <ContentRoute
        path={baseRouterUrl + '/mayorBook'}
        component={checkRouteAccess('accounting.Libro mayor', MayorBookPage, access)}
      />
      <ContentRoute
        path={baseRouterUrl + '/ivaventas'}
        component={checkRouteAccess('accounting.IVA Ventas', VatSalesPage, access)}
      />
      <ContentRoute
        path={baseRouterUrl + '/ivacompras'}
        component={checkRouteAccess('accounting.IVA Compras', VatPurchasesPage, access)}
      />
           <ContentRoute
        path={baseRouterUrl + '/ledgerBalance'}
        component={checkRouteAccess('accounting.Mayor de Saldos', LedgerBalancePage, access)}
      />
