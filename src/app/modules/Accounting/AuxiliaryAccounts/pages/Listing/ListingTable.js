...
export function ListingTable({ auxiliaryAccountsData }) {
    return (
        <div style={{ 
            margin: "0 auto", 
            padding: "10px", 
