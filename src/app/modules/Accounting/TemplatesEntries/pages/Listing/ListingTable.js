...
export function ListingTable({ seatingTemplates }) {
    return (
        <div style={{ 
            margin: "0 auto", 
            padding: "10px", 
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", textAlign: "center" }}>
                <thead style={{ backgroundColor: "#d9e1f2" }}>
                    <tr>
                        ...
                        <th style={{ border: "1px solid #d1d1d1", padding: "4px" }}>Módulo</th>
                        <th style={{ border: "1px solid #d1d1d1", padding: "4px" }}>Descripción</th>
                    </tr>
                </thead>
                <tbody>
                    {seatingTemplates.length > 0 ? (
                        seatingTemplates.map((item, index) => (
                            <tr key={index}>
                                <td style={{ border: "1px solid #d1d1d1", padding: "4px" }}>{item.id}</td>
                                <td style={{ border: "1px solid #d1d1d1", padding: "4px" }}>{item.module.module}</td>
