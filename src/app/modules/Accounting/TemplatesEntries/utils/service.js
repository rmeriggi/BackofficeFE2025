...
export const SEATING_TEMPLATES_URLS = {
    ...
    GET_ONE_HEADER: (id) => `${process.env.REACT_APP_API_URL}/seatingTemplates/header/${id}`,
    GET_ONE_DETAIL: (id) => `${process.env.REACT_APP_API_URL}/seatingTemplates/detail/${id}`,
    EDIT_HEADER: (id) => `${process.env.REACT_APP_API_URL}/seatingTemplates/header/${id}`,
    EDIT_DETAIL: (id) => `${process.env.REACT_APP_API_URL}/seatingTemplates/detail/${id}`,
...
export const editHeader = async(id, values) => {
    try {
        const response = await axios.post(SEATING_TEMPLATES_URLS.EDIT_HEADER(id), values)
        return response.data 
    } catch (error) {
...
export const editDetail = async(id, values) => {
    try {
        const response = await axios.post(SEATING_TEMPLATES_URLS.EDIT_DETAIL(id), values)
        return response.data 
    } catch (error) {
        throw new Error(error.response.data)
    }
...
export const createHeader = async(values) => {
    try {
        const response = await axios.post(SEATING_TEMPLATES_URLS.CREATE_HEADER, values);
        return response.data
    } catch (error) {
        throw new Error(error.response.data)
    }
...
export const createDetail = async(values) => {
    try {
        const response = await axios.post(SEATING_TEMPLATES_URLS.CREATE_DETAIL, values);
        return response.data
    } catch (error) {
        throw new Error(error.response.data)
    }
