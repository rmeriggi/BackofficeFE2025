  ...
  mock.onPost(LOGIN_URL).reply(({ data }) => {
    ...
    if (email && password) {
      if (email === 'gadehnerA1@gmail.com' && password === '1234') {
        return [200, { jwt: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjEsImNsaWVudElkIjo0LCJlbWFpbCI6ImdhZGVobmVyQTFAZ21haWwuY29tIiwibmFtZSI6IktldmluIiwibGFzdE5hbWUiOiJZYWd1YXIiLCJpYXQiOjI2MjUwNjQ2ODJ9.AOiujXPqrJt-QlhlEqkUqa1WkrrGy7FN9Exx2XxHuu0' }];
      }
      if (email === 'test@test.com.ar') {
        return [200, { jwt: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwibmFtZSI6InRlc3RAdGVzdC5jb20uYXIiLCJpYXQiOjE2MzUyNTY3NjN9.WMhbYIy9-m_prcPU5-1dbcFb_uu6Dv8dO435Pp6RIUA'}];
      }
    }
