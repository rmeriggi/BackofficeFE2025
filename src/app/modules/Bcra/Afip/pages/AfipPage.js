          ...
          <Form className="form form-label-right">
            <div className="form-group row">
              <div className="col-lg-4">
                <div
                  className={`card card-custom card-stretch-50 shadow mb-5 ${
                    isSuccessAfip ? "border border-success" : ""
                  }`}
                >
                  <div className="card-header">
                    <h3 className="card-title">AFIP_8126V2</h3>
                  </div>
                  <div className="card-body">AFIP_8126V2</div>
              ...
              <div className="col-lg-4">
                <div
                  className={`card card-custom card-stretch-50 shadow mb-5 ${
                    isSuccessExento ? "border border-success" : ""
                  }`}
                >
                  <div className="card-header">
                    <h3 className="card-title">AFIP_F778ExentoV2 </h3>
                  </div>
                  <div className="card-body">AFIP_F778ExentoV2</div>
                  <div className="card-footer">
                    <Button
                      variant="contained"
                      color="secondary"
              ...
              <div className="col-lg-4">
                <div
                  className={`card card-custom card-stretch-50 shadow mb-5 ${
                    isSuccessGrabado ? "border border-success" : ""
                  }`}
                >
                  <div className="card-header">
                    <h3 className="card-title">AFIP_F776GrabadoV2</h3>
                  </div>
                  <div className="card-body">AFIP_F776GrabadoV2</div>
                  <div className="card-footer">
                    <Button
                      variant="contained"
                      color="secondary"
