...
const ListingFilter = ({ setSectionBList, propertiesData }) => {
    ...
    const newListing = async(values) => {
        ...
        const responseSectionB = await getSectionB(dataValues)

        setSectionBList(responseSectionB)
        getScreenTitleToExcel("Apartados B", setNameExcel, values)
    }
