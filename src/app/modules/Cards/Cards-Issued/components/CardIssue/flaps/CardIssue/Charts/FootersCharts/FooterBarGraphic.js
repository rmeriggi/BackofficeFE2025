...
function progressBar(transactions) {
  ...
  const dataBar = [
    {
      title: "Este mes",
      progress: actualMonthValue,
      color: "#1F96EF",
      value: actualMonth.value,
    },
    {
      title: "Mes anterior",
      progress: lastMonthValue,
      color: "#8E76E6",
  ...
  return (
    <>
      <div className="d-flex justify-content-between px-4 py-5 border-bottom border-top align-items-center">
        <p className="m-0">
          <span className="text-uppercase text-muted mr-3">Mejor Día</span>
          {best}
        </p>
        <p className="m-0">
          <span className="text-uppercase text-muted mr-3">Promedio</span>
          {average}
        </p>
      </div>
