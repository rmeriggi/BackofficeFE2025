...
const ListingFilter = ({disabled, data}) => {
    ...
    const propertiesData = {
        header: ['ID', 'Nombre', 'Apellido', 'DNI', 'Fecha Alta', 'Fecha Vencimiento', 'N de Tarjeta', ],
        properties:['id', 'clientName', 'clientLastname', 'clientDni', 'timeStamp', 'expirationDate', 'cardNumber', ] ,
        array: report,
    }
    return (
        <>
            ...
            {data.length > 0 ? 
            (
            <div className="symbol-label ml-7" onClick={() => getExcel(propertiesData, "Tarjetas")}>
