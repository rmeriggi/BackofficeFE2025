...
import { getSuppliers } from "../../../../../../_redux/suppliers/suppliersActions";

export function DeleteSupplierModal({ show, setShow, supplierId, refetchSuppliers }) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      setOpenMessage("error", 'El proveedor no pudo ser eliminado correctamente. Por favor, volvé a intentar.');
    } finally {
      setProgress(false);
      setShow(false);
    }
