...
const ListingFilter = (props) => {
    ...
    const propertiesData = {
        header: ['ID',"Descripción",'Documento', 'Estado', 'Última actualización', 'Razón', 'Cliente'],
        properties:['id', "description",'document', 'statusDescription', 'lastUpdate', 'reason', 'clientName'] ,
        array: report,
    }
    ...
    return (
        <>
            ...
            {props.data.length > 0 ? 
            (
            <div className="symbol-label ml-7" onClick={() => getExcel(propertiesData, "Documentos")}>
