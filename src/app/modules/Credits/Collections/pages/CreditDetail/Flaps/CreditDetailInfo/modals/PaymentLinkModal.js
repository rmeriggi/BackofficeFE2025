...
import { Button, FormControlLabel, Switch, TextField, InputAdornment } from "@material-ui/core";
import { Field, Form, Formik } from "formik";
import { Input, Select } from "../../../../../../../../../_metronic/_partials/controls";
import useIsMountedRef from "../../../../../../../../hooks/useIsMountedRef";
import { useContactsTypes, useOneCredit } from "../../../../../utils/apiHook";
import { LayoutSplashScreen } from "../../../../../../../../../_metronic/layout";
import { useQuotasList } from "../../../../../utils/apiHook";
import { useParams } from "react-router-dom";
import { newPaymentLink } from "../../../../../utils/service";
...
export function PaymentLinkModal({ show, onHide, idPayment, action, quotaNumber, idManagment, clientPhone}) {
  ...
  const handlePaymentLink = async(values) => {
    try {
      const LinkUrl = await newPaymentLink(values)

     if(idTipoContacto==4) {window.open(`https://wa.me/${clientPhone}?text=${LinkUrl.id}`.replace(), '_blank')}
      ...
      <Modal.Body className="overlay overlay-block cursor-default">
        {!contactTypesCompleted ? (
          ...
          initialValues={{
            ...
            description: `Link de pago de la cuota ${quotaNumber} del credito numero ${id}`,
          ...
          onSubmit={(values) => {
            idTipoContacto = values.contactType;
