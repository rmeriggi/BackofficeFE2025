...
const CreditsPage = lazy(() => import("../Credits/Credits/pages/CreditsPage"));

const CollectionsPage = lazy(() =>
  import("../Credits/Collections/pages/CollectionsPage")
);

const WalletsPage = lazy(() => import("../Credits/Wallets/pages/WalletsPage"));

const QueryPage = lazy(() => import("../Credits/Queries/pages/QueryPage"));
  ...
  return (
    <Switch>
      ...
      <ContentRoute
        ...
        component={checkRouteAccess(
          "credits.Dashboard de cobranzas",
      ...
      <ContentRoute
        ...
        component={checkRouteAccess(
          "credits.Imputaciones externas",
          ExternalImputationsPage,
          access
        )}
      />
      <ContentRoute
      ...
      <ContentRoute
        ...
        component={checkRouteAccess(
          "credits.Campañas Cobranzas",
          CollectionsCampaignsPage,
          access
        )}
      />
