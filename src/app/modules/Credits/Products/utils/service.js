...
export const PRODUCTS_URLS = {
    ...
    GET_ALL_SCORING: (id) => `${process.env.REACT_APP_API_URL}/products/${id}/scoring`,
    CREATE_SCORING: `${process.env.REACT_APP_API_URL}/scoring`,
    DELETE_SCORING: (id) => `${process.env.REACT_APP_API_URL}/scoring/${id}`,
    GET_ALL_PROGRAMS: (id) => `${process.env.REACT_APP_API_URL}/credits/${id}/programs`,
    CREATE_PROGRAM: (id) => `${process.env.REACT_APP_API_URL}/credits/${id}/programs`,
    DELETE_PROGRAM: (id) => `${process.env.REACT_APP_API_URL}/credits/${id}/programs`,
...
export const getAllProducts = (values) => {
    ...
    return {call: axios.post(PRODUCTS_URLS.GET_ALL, values, {signal: controller.signal}), controller}
}
