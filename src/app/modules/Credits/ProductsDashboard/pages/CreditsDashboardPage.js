...
import { dashboardCollectionsAdapter, managersAdapter, productsAdapter } from '../../adapters';
...
const CreditsDashboardPage = () => {  
  ...
  useCallAPI(getAllProducts, setProducts, {idEntity: 0, idCurrency: 0}, productsAdapter, )
