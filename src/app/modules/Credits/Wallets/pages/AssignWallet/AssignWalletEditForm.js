...
const AssignWalletEditSchema = Yup.object().shape({
  feesDueMin: Yup.string().required("Mínimo de cuotas es un campo requerido"),
  feesDueMax: Yup.string().required("Máximo de cuotas es un campo requerido"),
  amountMin: Yup.string().required("Importe mínimo es un campo requerido"),
  amountMax: Yup.string().required("Importe máximo es un campo requerido"),
  daysLateFrom: Yup.string().required("Días DESDE es un campo requerido"),
  daysLateTo: Yup.string().required("Días HASTA es un campo requerido"),
});
...
export function AssignWalletEditForm({
  products,
  creditStatus,
  managers,
  openModal,
  ...
  const handleModal = async (values) => {
    ...
    try {
      ...
      setOpenMessage(
        "warning",
        "Verifique los datos antes de confirmar por favor."
      );
    } catch (e) {
      setOpenMessage(
        "error",
        "No se a podido cargar los datos para la asignación. Por favor, volvé a intentar."
      );
    }
  };
          ...
          <>
            <Form className="form form-label-right">
              ...
              <div className="form-group row" style={{ height: "110px" }}>
                ...
                <div className="col-lg-4 d-flex flex-wrap">
                  <span className={classes.fromToText}>
                    D&iacute;as de atraso
                  </span>
                  <div className={`col-lg-6 ${classes.fromToText}`}>
                    <Field
                      name="daysLateFrom"
