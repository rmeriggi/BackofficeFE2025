...
const ListingFilter = (props) => {
    ...
    const propertiesData = {
        header: ['Nombre de la cuenta', 'N° de la cuenta', 'Fecha de apertura', 'Moneda', 'Estado', 'Nombre del cliente', 'Cuit'],
        properties:['accountName', 'accountNumber', 'date', 'currency', 'status', 'client', 'cuit'] ,
        array: report,
    }
