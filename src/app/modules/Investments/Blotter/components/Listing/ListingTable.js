...
const filterData = (accountsData, filter) => {
  ...
  if (
    ...
    filteredData = accountsData.filter((account) => {
      const AuthorizedChargeTitles = ["", "SI", "NO", "QUANTEX"];
      ...
      if (
        ...
        account.money
          .trim()
          .toLowerCase()
          .includes(filter.money.toLowerCase()) ||
        account.operations
          .trim()
          .toLowerCase()
          .includes(filter.operations.toLowerCase()) ||
        account.description
          .trim()
          .toLowerCase()
        ...
        account.deadline
          .trim()
          .toLowerCase()
          .includes(filter.deadline.toLowerCase()) ||
        ...
        account.market
          .trim()
          .toLowerCase()
          .includes(filter.market.toLowerCase()) ||
        account.idOperator
          .trim()
          .toLowerCase()
          .includes(filter.idOperator.toLowerCase()) ||
        AuthorizedChargeTitles[Number(account.charge)] ===
          filter.charge.toUpperCase() ||
        account.authorized.trim().toLowerCase() ===
          filter.authorized.toLowerCase() ||
