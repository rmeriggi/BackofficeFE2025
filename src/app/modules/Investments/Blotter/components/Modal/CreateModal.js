...
import { getWallets, getOperations, getSpecies, getDeadline, getCounterparties, getMarkets, getCoins } from "../../../../../_redux/combos/combosActions";
...
const ProductEditSchema = Yup.object().shape({
  ...
  idSpecie: Yup.number().required("Este es un campo requerido").moreThan(0, "Este es un campo requerido"),
  ...
  idCounterparty: Yup.number().required("Este es un campo requerido").moreThan(0, "Este es un campo requerido"),
...
export function CreateModal(props) {
    ...
    const cat = [{id:1, cat:'FX'},{id:2, cat:'OP'},{id:3, cat:'PASE'}]
          ...
          <>
            <Modal.Body className="overlay overlay-block cursor-default">
                ...
                <div className="form-product row">
                    ...
                    />
                    <ErrorMessage name="idWallet">{error => <p className="text-danger text-xs">{error}</p>}</ErrorMessage>
                    </div>
                    <div className="col-lg-4">
                    ...
                    <GeneralSelectorArrow  
                        ...
                        setField={setFieldValue}
                    />
                     <ErrorMessage name="idOperations">{error => <p className="text-danger text-xs">{error}</p>}</ErrorMessage>
                    </div>
                    <div className="col-lg-4">
                    ...
                    <GeneralSelectorArrow  
                        ...
                        setField={setFieldValue}
                    />
                     <ErrorMessage name="idMoney">{error => <p className="text-danger text-xs">{error}</p>}</ErrorMessage>
                    </div>
                </div>  
                <div className="form-product row">
                <div style={{ position: 'relative' }} className="col-lg-4">
                    ...
                    <GeneralSelectorSearch  
                        ...
                        setField={setFieldValue}
                    />
                     <ErrorMessage name="idSpecie">{error => <p className="text-danger text-xs">{error}</p>}</ErrorMessage>
                    </div>
                    <div className="col-lg-4">
                    ...
                    <GeneralSelectorArrow  
                        ...
                        setField={setFieldValue}
                    />
                     <ErrorMessage name="idDeadline">{error => <p className="text-danger text-xs">{error}</p>}</ErrorMessage>
                    </div>                   
                    <div className="col-lg-4">
                    ...
                    <Field
                        ...
                        component={Input}
                        style={{ backgroundColor: 'inherit', borderColor: 'inherit', color: 'inherit' }}
                        placeholder=""
                        type="text"
                        label=""
                        onChange={(e) => {
                          setFieldValue("quantityFormatter", e.target.value.replace(/[^0-9]/g, '').replace(/\B(?=(\d{3})+(?!\d))/g, '.'))
                          setFieldValue("quantity", e.target.value.replace(/[^0-9]/g, ''))
                        }}
                    />
                ...
                <div className="form-product row">
                    ...
                    <Field
                        name="amount" 
                        readOnly
                        value={values.amount = values.price.includes(',') ? new Intl.NumberFormat("de-DE", {minimumFractionDigits:2,  maximumFractionDigits: 2}).format((Number(values.price.replace(/\./g, '').replace(',', '.'))*values.quantity)/100):new Intl.NumberFormat("de-DE", {minimumFractionDigits:2,  maximumFractionDigits: 2}).format((values.price*values.quantity)/100)}
                        component={Input}
                        style={{ backgroundColor: 'inherit', borderColor: 'inherit', color: 'inherit' }}
                        placeholder=""
                        type="text"
                    ...
                    <GeneralSelectorSearch  
                        ...
                        setField={setFieldValue}
                    />
                     <ErrorMessage name="idCounterparty">{error => <p className="text-danger text-xs">{error}</p>}</ErrorMessage>
                    </div>
                </div> 
                <div className="form-product row">
                <div className="col-lg-4">
                    ...
                    <GeneralSelectorArrow  
                        ...
                        setField={setFieldValue}
                    />
                    <ErrorMessage name="idMarket">{error => <p className="text-danger text-xs">{error}</p>}</ErrorMessage>
                    </div>
                    <div className="col-lg-4">
                    <label className="font-size-h7 col-form-label text-lg-left">OBS</label> 
                    <GeneralSelectorArrow  
                        values={values}
                        valueName='FX'
                        keyName='cat'
                        ...
                        setField={setFieldValue}
                    />
                    <ErrorMessage name="FX">{error => <p className="text-danger text-xs">{error}</p>}</ErrorMessage>
                    </div>
                    <div className="col-lg-4">
                ...
                <div className="col-lg-12">
                     <label className="font-size-h7 col-lg-12 col-form-label text-lg-left">NOTAS</label>    
                        <Field
                        type="text"
                        class="form-control"
                        name="notes"
