...
export default function Listing() {
    ...
    const [speciesInstrument , loadingInstrument]=useFetchBlottersSpeciesInstrument()
    const [pnlsInstrument , loadingPnlsInstrument]=useFetchBlottersPnlInstrument()

    console.log('cashMoney', cashMoney)
    console.log('speciesInstrument', speciesInstrument )
    // console.log('pnlsInstrument', pnlsInstrument )
    if(!cashMoney || loadingcashMoney || !speciesInstrument || loadingInstrument){
