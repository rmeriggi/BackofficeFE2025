...
export function EditModal(props) {
  ...
  const initialValues = {
    ...
    esCertificateOfPartFideicomisos:
      props.editInitialData.esCertificateOfPartFideicomisos,
    ...
    esOtroTituloEmitidoPorBCRA:
      props.editInitialData.esOtroTituloEmitidoPorBCRA,
