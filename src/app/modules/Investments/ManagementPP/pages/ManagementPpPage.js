        ...
        {plazosFiltrados.map((pf) => (
          ...
          >
            ...
            >
              ...
              <div className="card-footer border-0 d-flex justify-content-end pt-0 pb-6 px-6">
                <button
                  onClick={() =>
                    history.push("/investments/adminpp/update/" + pf.id)
                  }
...
export default ManagementPpPage;
