...
const ProductEditSchema = Yup.object().shape({
  IDComitenteESCO: Yup.number().required("IDComitenteESCO es un campo requerido"), 
  NroComitenteESCO: Yup.number().required("NroComitenteESCO es un campo requerido"), 
  NroCtaContableESCO: Yup.number().required("NroCtaContableESCO es un campo requerido"), 
            ...
            <Modal.Body className="overlay overlay-block cursor-default">
                ...
                <div className="form-product row">
                    ...
                    />
                     ...
                     <div className="col-lg-4">
                    <label className="font-size-h7 col-lg-4 col-form-label text-lg-left">NroComitenteESCO</label> 
                    <Field
                    ...
                    <div className="col-lg-4">
                    <label className="font-size-h7 col-lg-4 col-form-label text-lg-left">IDComitenteESCO</label> 
                    <Field
                ...
                <div className="form-product row">
                     <div className="col-lg-4">
                    <label className="font-size-h7 col-lg-4 col-form-label text-lg-left">NroCtaContableESCO</label> 
                    <Field
