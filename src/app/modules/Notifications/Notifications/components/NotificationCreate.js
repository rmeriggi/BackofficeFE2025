...
export function NotificationCreate() {
  ...
  const handleCreate = async (value) => {
    try {
      ...
      setOpenMessage(
        "error",
        "La notificación no pudo ser creada correctamente. Por favor, volvé a intentar."
      );
    }
  };
            ...
            {({
              ...
              <Form className="form form-label-right">
                ...
                <div className="form-product row mb-5">
                  <div className="col-lg-6">
                    <label className="font-size-h7 col-lg-6 col-form-label text-lg-left pt-0 pb-2 pl-0">
                      DESCRIPCION
                    </label>
                    <Field
                      as="textarea"
                ...
                <div className="form-product row">
                  <div className="col-lg-6">
                    <label className="font-size-h7 text-lg-left pt-0">
                      ESTADO
                    </label>
                    <GeneralSelector
                      values={values}
