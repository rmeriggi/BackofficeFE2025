...
export function ListingTable( { cashoutData, columnsData, openReceipt } ) {
    ...
    return (
        cashoutData.length === 0 ? (
            <TableNoRecordsFoundMessage entities={"cashout"}/>
        ) : (
            <PaginatedTable
                columns={columns}
                data={cashoutData}
...
ListingTable.propTypes = {
    cashoutData: propTypes.arrayOf(propTypes.shape({
        id: propTypes.string,
