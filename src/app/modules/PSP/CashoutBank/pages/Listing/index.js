...
import { useCashoutTransactions, useCashoutTransactionsConsult } from "../../utils/apiHooks";
...
export default function Listing({data}) {
    ...
    const [transactionsData, transactionsCompleted] = useCashoutTransactions(isMountedRef)
    const [show, showModal, closeModal] = useModal()
    const [showConsultBank, showModalConsultBank, closeModalConsultBank] = useModal()
    ...
    return (
        <Card>
            ...
            <ModalDetailBankCashout show={showConsultBank} onHide={closeModalConsultBank} id={dataConsultBank}/>
        </Card>
    )
}