...
export function ActionColumnFormatter(cellContent,row, rowIndex, {openEditTaxPage, openDetailTax}){
  ...
  return (
    <>
      ...
      >
        <Button
          className="btn btn-icon btn-light btn-m"
          onClick={()=> openEditTaxPage(row.id)} 
        >
          <span className="svg-icon svg-icon-b svg-icon-primary">
            <SVG
